...
var RendererService = /** @class */ (function () {
    ...
    RendererService.prototype.render = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var storyProps$, moduleMetadata, resetCompiledComponents;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        storyProps$ = new rxjs_1.BehaviorSubject(storyFnAngular.props);
                        moduleMetadata = StorybookModule_1.getStorybookModuleMetadata({ storyFnAngular: storyFnAngular, parameters: parameters, targetSelector: RendererService.SELECTOR_STORYBOOK_WRAPPER }, storyProps$);
                        ...
                        try {
                            resetCompiledComponents = require('@angular/core').ɵresetCompiledComponents;
                        ...
                        return [4 /*yield*/, this.newPlatformBrowserDynamic().bootstrapModule(StorybookModule_1.createStorybookModule(moduleMetadata), (_b = parameters.bootstrapModuleOptions) !== null && _b !== void 0 ? _b : undefined)];
                    case 1:
                        _c.sent();
                        return [2 /*return*/];
                }
    ...
    RendererService.prototype.fullRendererRequired = function (_a) {
        var _b, _c;
        var storyFnAngular = _a.storyFnAngular, moduleMetadata = _a.moduleMetadata, forced = _a.forced;
        var lastStoryRender = this.currentStoryRender;
        ...
        var hasChangedTemplate = !!(storyFnAngular === null || storyFnAngular === void 0 ? void 0 : storyFnAngular.template) &&
            ((_b = lastStoryRender === null || lastStoryRender === void 0 ? void 0 : lastStoryRender.storyFnAngular) === null || _b === void 0 ? void 0 : _b.template) !== storyFnAngular.template;
        if (hasChangedTemplate) {
            return true;
        }
        // force the rendering if the metadata structure has changed
        var hasChangedModuleMetadata = ((_c = this.currentStoryRender) === null || _c === void 0 ? void 0 : _c.moduleMetadataSnapshot) !== (lastStoryRender === null || lastStoryRender === void 0 ? void 0 : lastStoryRender.moduleMetadataSnapshot);
