...
var AbstractRenderer = /** @class */ (function () {
  ...
  AbstractRenderer.resetPlatformBrowserDynamic = function () {
    ...
    return new Promise(function (resolve) {
      if (platformRef && !platformRef.destroyed) {
        platformRef.onDestroy(function () {
  ...
  AbstractRenderer.prototype.render = function (_a) {
    ...
    var storyFnAngular = _a.storyFnAngular,
      ...
      targetDOMNode = _a.targetDOMNode;
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            moduleMetadata = StorybookModule_1.getStorybookModuleMetadata(
              {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              getPlatform().bootstrapModule(
                StorybookModule_1.createStorybookModule(moduleMetadata),
                (_b = parameters.bootstrapModuleOptions) !== null &&
                  _b !== void 0
                  ? _b
                  : undefined
              ),
   ...
   * Otherwise, it generates a unique valid HTML tag name from storyId by removing non-ASCII alphanumerics from storyId, prefixing "sb-", and suffixing UNIX timestamp
   *
   * @protected
  ...
  AbstractRenderer.prototype.generateTargetSelectorFromStoryId = function () {
    ...
    return storyIdIsInvalidHtmlTagName
      ? "sb-" + this.storyId.replace(invalidHtmlTag, "") + new Date().getTime()
      : this.storyId;
  };
  AbstractRenderer.prototype.initAngularRootElement = function (
    targetDOMNode,
    targetSelector
  ) {
  ...
  AbstractRenderer.prototype.fullRendererRequired = function (_a) {
    var _b;
    var storyFnAngular = _a.storyFnAngular,
      moduleMetadata = _a.moduleMetadata,
      forced = _a.forced;
    ...
    var hasChangedTemplate =
      !!(storyFnAngular === null || storyFnAngular === void 0
        ? void 0
        : storyFnAngular.template) &&
      ((_b =
        previousStoryRenderInfo === null || previousStoryRenderInfo === void 0
          ? void 0
          : previousStoryRenderInfo.storyFnAngular) === null || _b === void 0
        ? void 0
        : _b.template) !== storyFnAngular.template;
    if (hasChangedTemplate) {
      return true;
    }
    // force the rendering if the metadata structure has changed
    var hasChangedModuleMetadata =
   ...
   */
  AbstractRenderer.resetCompiledComponents = function () {
          ...
          case 0:
            ...
            return [
              ...
              Promise.resolve().then(function () {
                return __importStar(require("@angular/core"));
              }),
            ];
          case 1:
